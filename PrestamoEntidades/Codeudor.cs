...
namespace PrestamoEntidades
{
    ...
    {
        [KeyAttribute]
        public int IdCodeudor { get; set; } = 0;
        [IgnoreOnParams]
        [StringLength(40)]
        [Required]
    ...
    public class CodeudorGetParams : BaseGetParams
    //: BaseGetParams
    {
        public string Codigo { get; set; } = string.Empty;
        public int IdCodeudor { get; set; } = -1;
        /// <summary>
        ...
        /// </summary>
        public int SeleccionarLuegoDelIdCodeudor { get; set; } = -1;
    ...
    public class BuscarCodeudorParams : BaseGetParams
    {
