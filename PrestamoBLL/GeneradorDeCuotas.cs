...
{
    internal static class GeneradorDeCuotas
    {
        ...
        {
            var result = SelectGeneradorDeCuotas(infGenCuotas) as GeneradorCuotasFijasNoAmortizable;
        ...
        private static IGeneradorCuotas SelectGeneradorDeCuotas(IInfoGeneradorCuotas info)
        {
