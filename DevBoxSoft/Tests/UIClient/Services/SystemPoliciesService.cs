...
namespace UIClient.Services
{
    public class SystemPoliciesService : HttpServiceBase
    {
        ...
        public SystemPoliciesService(IHttpClientFactory clientFactory, IConfiguration configuration, ILocalStorageService localStorageService, NotificationService notificationService) : base("SysPolicies2", clientFactory, configuration, localStorageService, notificationService)
        {
