...
function GenerarFichaDrCr(datos = null) {
    ...
    myWindow.document.write(`Prestamo:${NumeracionDocumento}` + "<br />");
    myWindow.document.write(`Cliente:${NombreCompletoCliente}` + "<br />");
    myWindow.document.write(`Garantia:${NumeracionGarantia}` + "<br />");
    myWindow.document.write(`Fecha:${Fecha}` + "<br />");
    myWindow.document.write("------------------------------------------------" + "<br />");
    ...
    myWindow.document.write(`Bce:${BalanceDocumentoCXC}` + "<br />");
    myWindow.document.write(`Bce:${MontoPagado}` + "<br />");
    myWindow.document.write(`Bce:${BalanceDocumentoCXC - MontoPagado}` + "<br />");
    myWindow.document.write(`OTROS PRESTAMOS ACTIVOS` + "<br />");
    myWindow.document.write(`Bce:${BalanceDocumentoCXC - MontoAtrasado}` + "<br />");
    myWindow.document.write(`INFORMACION DE DEUDA ATRASADA` + "<br />");
    myWindow.document.write(`Pagares Atrasados:${CuotasAtrasadas}` + "<br />");
    myWindow.document.write(`Monto Atrasado:${MontoAtrasado}` + "<br />");
    myWindow.document.write(`Total Pagares/Pagar:${Math.round(MontoAtrasado / CuotasAtrasadas)}` + "<br />");
