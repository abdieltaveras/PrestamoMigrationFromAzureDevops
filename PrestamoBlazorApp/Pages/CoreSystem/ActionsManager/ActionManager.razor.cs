...
namespace PrestamoBlazorApp.Pages.CoreSystem.ActionsManager
{
    ...
    class EntityType
    {
        static public EntityType None => new EntityType() { Name = "", Icon = Icons.Material.Filled.TabUnselected };
        static public EntityType Group => new EntityType() { Name = "Grupo", Icon = Icons.Material.Filled.Group };
        static public EntityType User => new EntityType() { Name = "Usuario", Icon = Icons.Material.Filled.Person };
