...
{
    public partial class ClasificacionesV2 : BaseForCreateOrEdit
    {
        [Inject]
        ...
        //    await UnBlockPage();
        //    await SweetMessageBox("Guardado Correctamente", "success", "/clasificacionesV2");
        //}
        ...
        private async Task ShowDialog(int id = -1)
        {
            ...
            parameters.Add("idClasificacion", id);
            var dialog = DialogService.Show<CreateClasificaciones>("", parameters, Showdialogs.BasicOptions);
