...

{
    ...
    public class NegocioTests
    {
        ...
        public void InsUpdNegocio()
        {
            ...
            //    NombreJuridico = "Nombre Juric",
            //    idNegocioPadre = 0,
            //};
            //var a= new NegocioBLL(1, "Prueba").InsUpd(negocio);
        }
        ...
        //    string password = "1";
        //    var login = BLLPrestamo.Instance.Login(loginName,password,1);
