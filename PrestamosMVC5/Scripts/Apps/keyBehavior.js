...
$(function () {
    ...
    var inputElems = $("[data-input='true']");
    ...
    inputElems.focusin(function () {
        var _this = this;
        currentField = inputElemsIndexById.findIndex(function (elem) { return elem === _this.id; });
    });
    ...
    function keyDown(e) {
        if (e.which === keyEnter || e.which === keyDownArrow) {
            ...
            if (currentField < inputElems.length) {
                currentField++;
            }
            else {
                currentField = inputElems.length;
            }
    ...
    function moveToField(fieldNumber) {
        var fieldToFocus = $("#" + inputElemsIndexById[fieldNumber]);
        fieldToFocus.focus();
