...
namespace PrestamosMVC5.Models
{
    ...
    public static class SelectItems
    {
        ...
        public static SelectList  EstadoCiviles () => new SelectList(BLLPrestamo.Instance.CatalogosGet(new BaseCatalogoGetParams {NombreTabla = "tblEstadosCiviles", IdTabla = "IdEstadoCivil" }), "IdEstadoCivil", "Nombre");
